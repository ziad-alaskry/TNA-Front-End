                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="md:col-span-2 p-8 rounded-md bg-primary-dark text-white shadow-card relative overflow-hidden flex flex-col justify-between min-h-[180px]">
                        <div className="relative z-10">
                            <p className="text-sm font-medium mb-1">الرصيد القابل للسحب</p>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="p-6 rounded-md border border-neutral-200 bg-surface-200">
                            ...
                            <p className="text-[10px] text-neutral-500 mt-1">آخر عملية منذ ١٠ أيام</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-6 rounded-md border border-neutral-200 bg-surface-200">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div className="flex gap-2">
                            {['يوم', 'أسبوع', 'شهر', 'سنة'].map(v => (
                                <button key={v} className={`px-3 py-1 rounded text-[10px] font-bold transition-all ${v === 'أسبوع' ? 'bg-primary text-white' : 'text-neutral-600 hover:text-neutral-900'}`}>{v}</button>
                            ))}
                        </div>
                    </div>
                    <div className="h-48 w-full bg-surface-100 rounded border border-neutral-100 border-dashed flex items-center justify-center overflow-hidden relative">
                         <div className="absolute inset-x-0 bottom-0 top-1/2 bg-gradient-to-t from-primary/5 to-transparent shadow-inner" />
                          <p className="text-xs text-neutral-600 font-medium z-10 px-4 py-2 bg-white/50 backdrop-blur-md rounded-pill border border-neutral-200">الرسم البياني للتوزيع المالي سيظهر هنا</p>
                    </div>
                </div>
