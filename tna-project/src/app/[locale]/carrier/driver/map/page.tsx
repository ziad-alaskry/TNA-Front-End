                ...
                <div className="flex-1 rounded-md border border-neutral-200 bg-surface-200 relative overflow-hidden flex items-center justify-center">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                        <div className="bg-white px-3 py-1 rounded shadow-lg border border-neutral-200 mb-2 whitespace-nowrap">
                            <span className="text-xs font-bold text-neutral-900">{t('carrier.driver.map.pin_label')}</span>
                        </div>
                    ...
                    <p className="text-xs text-neutral-400 font-medium z-10 px-6 py-2 bg-white/50 backdrop-blur-sm rounded-pill border border-neutral-200">{t('carrier.driver.map.placeholder')}</p>
                </div>
                        ...
                        <div>
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <div className="flex items-center gap-1.5 text-success">
                                    ...
                                    <span className="text-[10px] font-bold">{t('carrier.driver.map.active')}</span>
                                </div>
                            </div>
                            <h3 className="text-2xl font-mono font-bold tracking-wider mb-1">TNA-667722</h3>
                            <p className="text-xs opacity-60">{t('carrier.driver.map.express_delivery')}</p>
                        </div>
                        <div className="flex items-center gap-4 border-t border-white/10 pt-4">
                            <div className="flex-1">
                                <p className="text-[10px] text-white/40 uppercase mb-0.5">{t('carrier.driver.map.distance')}</p>
                                <p className="text-sm font-bold">{t('carrier.driver.map.distance_value')}</p>
                            </div>
                            <div className="flex-1">
                                <p className="text-[10px] text-white/40 uppercase mb-0.5">{t('carrier.driver.map.eta')}</p>
                                <p className="text-sm font-bold">{t('carrier.driver.map.eta_value')}</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-neutral-900">{t('carrier.driver.map.delivery_date_value')}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded bg-neutral-100 flex items-center justify-center text-neutral-400">
                                ...
                                <div>
                                    <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-widest">{t('carrier.driver.map.delivery_address')}</p>
                                    <p className="text-xs font-bold text-neutral-700 leading-relaxed">{t('carrier.driver.map.delivery_address_value')}</p>
                                </div>
                            </div>
                        </div>
