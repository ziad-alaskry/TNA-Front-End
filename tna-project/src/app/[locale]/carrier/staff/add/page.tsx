...
const staffSchema = z.object({
  ...
  national_id: z.string().min(10, 'رقم الهوية يجب أن يتكون من 10 أرقام'),
  ...
  const steps = [
    {
      id: 'step1',
      label: 'بيانات الموظف',
      title: 'تفاصيل الموظف / السائق',
      description: 'أدخل المعلومات الأساسية للموظف الجديد.',
      content: (
    ...
    },
    {
      id: 'step2',
      label: 'بيانات الهوية',
      title: 'معلومات الهوية الوطنية',
      description: 'أدخل بيانات الهوية الرسمية للموظف.',
      content: (
        <div className="space-y-6">
          <InputField
          ...
          />
          <div className="p-4 bg-info-bg rounded-md flex gap-3">
             <Info size={24} className="text-primary shrink-0" weight="fill" />
             <p className="text-xs text-neutral-600 leading-relaxed">
                تساعدنا هذه البيانات في التحقق من أهلية الموظف وضمان سلامة العمليات.
             </p>
          </div>
        </div>
      ),
    },
    {
      ...
      title: 'مراجعة وتأكيد',
      description: 'تأكد من صحة المعلومات قبل إضافة الموظف.',
      content: (
        <div className="space-y-6">
          <div className="bg-surface-200 border border-neutral-200 rounded-md divide-y divide-neutral-100 overflow-hidden">
            ...
            <div className="p-4 flex justify-between items-center">
              <span className="text-sm text-neutral-500">رقم الهوية</span>
              <span className="text-sm font-bold text-neutral-900">{watch('national_id')}</span>
            </div>
            <div className="p-4 flex justify-between items-center">
              <span className="text-sm text-neutral-500">الجنسية</span>
              <span className="text-sm font-bold text-neutral-900">{watch('nationality')}</span>
            </div>
