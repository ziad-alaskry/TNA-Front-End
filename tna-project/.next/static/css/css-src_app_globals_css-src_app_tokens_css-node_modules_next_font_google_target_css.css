/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** css ./node_modules/next/dist/build/webpack/loaders/css-loader/src/index.js??ruleSet[1].rules[13].oneOf[2].use[1]!./node_modules/next/dist/build/webpack/loaders/next-font-loader/index.js??ruleSet[1].rules[13].oneOf[2].use[2]!./node_modules/next/font/google/target.css?{"path":"src\\app\\[locale]\\layout.tsx","import":"Rubik","arguments":[{"subsets":["latin","arabic"],"weight":["300","400","500","600","700","800"]}],"variableName":"rubik"} ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/* arabic */
@font-face {
  font-family: '__Rubik_d2a5de';
  font-style: normal;
  font-weight: 300;
  font-display: swap;
  src: url(/_next/static/media/32c80fb7588b7a2e-s.p.woff2) format('woff2');
...
@font-face {
  ...
  src: url(/_next/static/media/0a86735c6520d94f-s.p.woff2) format('woff2');
  unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+0304, U+0308, U+0329, U+2000-206F, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;
}@font-face {font-family: '__Rubik_Fallback_d2a5de';src: local("Arial");ascent-override: 89.06%;descent-override: 23.81%;line-gap-override: 0.00%;size-adjust: 104.98%
}.__className_d2a5de {font-family: '__Rubik_d2a5de', '__Rubik_Fallback_d2a5de';font-style: normal
}

/*!****************************************************************************************************************************************************************************************************************************************************************!*\
  !*** css ./node_modules/next/dist/build/webpack/loaders/css-loader/src/index.js??ruleSet[1].rules[13].oneOf[12].use[2]!./node_modules/next/dist/build/webpack/loaders/postcss-loader/src/index.js??ruleSet[1].rules[13].oneOf[12].use[3]!./src/app/tokens.css ***!
  \****************************************************************************************************************************************************************************************************************************************************************/
/* ═══════════════════════════════════════════════════
   SPATIAL Design Token System — tokens.css
   Source of truth: Brand PDF + 14 Figma Screens
   Base unit: 4px grid
═══════════════════════════════════════════════════ */

:root {
  /* ─── BRAND PRIMITIVES ─── */
  --primitive-cyan-light: #18CCE5;
  --primitive-cyan-mid: #00B4C9;
  --primitive-navy: #02488D;
  --primitive-navy-dark: #013A70;
  --primitive-navy-light: #1A6FC4;
  --primitive-amber: #F5A623;
  --primitive-green: #28A745;
  --primitive-red: #DC3545;

  /* ─── SEMANTIC: BRAND ─── */
  --color-brand-primary: #F68B1E; /* Orange Theme */
  --color-brand-secondary: #FFB347;
  ...
  --color-error-border: #F5B3BA;
  --color-warning: #F5A623;
  --color-warning-bg: #FEF6E7;
  --color-warning-border: #FAD98D;
  --color-info: #00B4C9;
  --color-info-bg: #E6F7FA;
  --color-info-border: #99DDE8;
  --color-pending: #1A6FC4;
  --color-pending-bg: #EAF2FB;
  ...
  /* ─── SURFACE LEVELS ─── */
  --surface-100: #F4F5F6; /* main app bg */
  --surface-200: #FFFFFF; /* cards, sections */
  --surface-300: #FFFFFF; /* modals, sheets */
  --surface-dark-100: #02488D;
  --surface-dark-200: #013A70;
  --surface-dark-300: #0A1E3D;
  ...
  /* ─── SHADOWS ─── */
  --shadow-card: 0 2px 8px rgba(246, 139, 30, 0.08);
  --shadow-modal: 0 8px 32px rgba(246, 139, 30, 0.16);
  --shadow-btn: 0 4px 16px rgba(246, 139, 30, 0.30);
  --shadow-glow-primary: 0 0 12px rgba(246, 139, 30, 0.40);
  --shadow-glow-cyan: 0 0 12px rgba(0, 180, 201, 0.35);
  --shadow-navbar: 0 -1px 8px rgba(0, 0, 0, 0.06);

  /* ─── COMPONENT: PRIMARY BUTTON ─── */
  --btn-primary-height: 56px;
  --btn-primary-radius: var(--radius-pill);
  --btn-primary-font-size: var(--text-body-size);
  --btn-primary-weight: 700;
  --btn-primary-color: #FFFFFF;
  --btn-primary-bg: linear-gradient(135deg, #F68B1E, #FFB347);

  /* ─── COMPONENT: OUTLINE BUTTON ─── */
  --btn-outline-height: 52px;
  --btn-outline-radius: var(--radius-pill);
  --btn-outline-border: 1.5px solid #00B4C9;
  ...
  --input-bg: #FFFFFF;
  --input-border: 1px solid #D8DBDF;
  --input-border-focus: 1.5px solid #F68B1E;

  /* ─── NAVIGATION BAR ─── */
  --navbar-height: 72px;
  --navbar-bg: #FFFFFF;
  --navbar-icon-active: #F68B1E;
  --navbar-icon-inactive: #B7B7B7;
  --navbar-active-bar: 3px solid #F5A623;

  /* ─── BOTTOM NAV (Mobile) ─── */
  --bottom-nav-height: 64px;
  --bottom-nav-bg: rgba(255, 255, 255, 0.92);
  --bottom-nav-active-dot: #F68B1E;
  --bottom-nav-inactive: #B7B7B7;
}
...
[hidden]:where(:not([hidden="until-found"])) {
  ...
  :root {
    ...
    --sidebar-accent-foreground: var(--color-brand-primary);
    --sidebar-border: var(--neutral-200);
    --sidebar-ring: var(--primitive-cyan-mid);
  }
...
/* ── SPATIAL Card Contract ── */
/* ── Dark Surface Overlay (Nav headers, modals) ── */
...
.divide-neutral-200 > :not([hidden]) ~ :not([hidden]) {
  --tw-divide-opacity: 1;
  border-color: rgb(234 236 238 / var(--tw-divide-opacity, 1));
}
.overflow-hidden {
  overflow: hidden;
}
...
.border-brand-cyan {
  border-color: var(--primitive-cyan-mid);
}
.border-error {
  --tw-border-opacity: 1;
...
.border-error-border {
  --tw-border-opacity: 1;
  border-color: rgb(245 179 186 / var(--tw-border-opacity, 1));
}
.border-error\/10 {
  border-color: rgb(220 53 69 / 0.1);
}
.border-error\/20 {
  border-color: rgb(220 53 69 / 0.2);
}
.border-gray-200 {
  --tw-border-opacity: 1;
...
.border-info {
  --tw-border-opacity: 1;
  border-color: rgb(0 180 201 / var(--tw-border-opacity, 1));
}
.border-info-border {
  --tw-border-opacity: 1;
  border-color: rgb(153 221 232 / var(--tw-border-opacity, 1));
}
.border-neutral-100 {
  --tw-border-opacity: 1;
...
.border-neutral-300 {
  --tw-border-opacity: 1;
  border-color: rgb(216 219 223 / var(--tw-border-opacity, 1));
}
.border-pending {
  --tw-border-opacity: 1;
  border-color: rgb(26 111 196 / var(--tw-border-opacity, 1));
}
.border-primary {
...
.border-success\/20 {
  border-color: rgb(40 167 69 / 0.2);
}
.border-success\/30 {
  border-color: rgb(40 167 69 / 0.3);
}
.border-transparent {
...
.border-warning-border {
  --tw-border-opacity: 1;
  border-color: rgb(250 217 141 / var(--tw-border-opacity, 1));
}
.border-warning\/10 {
  border-color: rgb(245 166 35 / 0.1);
}
.border-white {
  --tw-border-opacity: 1;
...
.border-t-brand-cyan {
  border-top-color: var(--primitive-cyan-mid);
}
.border-t-primary {
...
.bg-brand-cyan {
  background-color: var(--primitive-cyan-mid);
}
.bg-brand-navy {
  background-color: var(--primitive-navy);
}
.bg-error {
  --tw-bg-opacity: 1;
...
.bg-neutral-300 {
  --tw-bg-opacity: 1;
  background-color: rgb(216 219 223 / var(--tw-bg-opacity, 1));
}
.bg-neutral-400 {
  --tw-bg-opacity: 1;
...
.bg-neutral-900 {
  --tw-bg-opacity: 1;
  background-color: rgb(10 13 16 / var(--tw-bg-opacity, 1));
}
.bg-neutral-900\/40 {
  background-color: rgb(10 13 16 / 0.4);
}
.bg-neutral-900\/50 {
  background-color: rgb(10 13 16 / 0.5);
}
.bg-pending {
  --tw-bg-opacity: 1;
  background-color: rgb(26 111 196 / var(--tw-bg-opacity, 1));
}
.bg-pending-bg {
  --tw-bg-opacity: 1;
...
.bg-success-bg {
  --tw-bg-opacity: 1;
  background-color: rgb(232 247 236 / var(--tw-bg-opacity, 1));
}
.bg-success\/10 {
...
.from-brand-navy-dark {
  --tw-gradient-from: var(--primitive-navy-dark) var(--tw-gradient-from-position);
...
.via-neutral-800 {
  --tw-gradient-to: rgb(30 34 40 / 0)  var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), #1E2228 var(--tw-gradient-via-position), var(--tw-gradient-to);
}
.to-neutral-700 {
  --tw-gradient-to: #3A3F47 var(--tw-gradient-to-position);
}
.to-transparent {
...
.text-info {
  --tw-text-opacity: 1;
  color: rgb(0 180 201 / var(--tw-text-opacity, 1));
}
.text-neutral-300 {
  --tw-text-opacity: 1;
  color: rgb(216 219 223 / var(--tw-text-opacity, 1));
}
.text-neutral-400 {
  --tw-text-opacity: 1;
...
.text-neutral-600 {
  --tw-text-opacity: 1;
  color: rgb(92 99 112 / var(--tw-text-opacity, 1));
}
.text-neutral-700 {
  --tw-text-opacity: 1;
  color: rgb(58 63 71 / var(--tw-text-opacity, 1));
}
.text-neutral-800 {
  --tw-text-opacity: 1;
  color: rgb(30 34 40 / var(--tw-text-opacity, 1));
}
.text-neutral-900 {
  --tw-text-opacity: 1;
  color: rgb(10 13 16 / var(--tw-text-opacity, 1));
}
.text-pending {
  --tw-text-opacity: 1;
  color: rgb(26 111 196 / var(--tw-text-opacity, 1));
}
.text-primary {
  color: var(--primary);
}
...
.placeholder-neutral-400::-moz-placeholder {
  ...
  color: rgb(183 183 183 / var(--tw-placeholder-opacity, 1));
}
...
.shadow-\[0_-4px_20px_rgba\(0\2c 0\2c 0\2c 0\.03\)\] {
  --tw-shadow: 0 -4px 20px rgba(0,0,0,0.03);
  --tw-shadow-colored: 0 -4px 20px var(--tw-shadow-color);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
.shadow-btn {
  --tw-shadow: var(--shadow-btn);
  --tw-shadow-colored: var(--shadow-btn);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
.shadow-card {
...
.shadow-glow-primary {
  ...
  --tw-shadow-colored: var(--shadow-glow-primary);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
.shadow-inner {
...
.ring-error\/20 {
  --tw-ring-color: rgb(220 53 69 / 0.2);
}
.ring-neutral-200\/50 {
  --tw-ring-color: rgb(234 236 238 / 0.5);
}
.ring-success\/10 {
  --tw-ring-color: rgb(40 167 69 / 0.1);
}
.blur {
  --tw-blur: blur(8px);
...
@import url('https://fonts.googleapis.com/css2?family=Rubik:wght@300;400;500;600;700;800&family=JetBrains+Mono:wght@400;500&display=swap');
...
.dark {
  ...
  --popover: var(--surface-dark-200);
  --popover-foreground: #F4F5F6;
  --primary: var(--color-brand-primary);
  --primary-foreground: #FFFFFF;
  --secondary: var(--color-brand-secondary);
  --secondary-foreground: #FFFFFF;
  --muted: var(--surface-dark-200);
  ...
  --ring: var(--primitive-cyan-mid);
  --sidebar: var(--surface-dark-200);
  --sidebar-foreground: #F4F5F6;
  --sidebar-primary: var(--color-brand-primary);
  --sidebar-primary-foreground: #FFFFFF;
  --sidebar-accent: var(--surface-dark-100);
  --sidebar-accent-foreground: var(--color-brand-primary);
...
.disabled\:grayscale-\[0\.5\]:disabled {
...
.group:focus-within .group-focus-within\:text-brand-cyan {
  color: var(--primitive-cyan-mid);
}
